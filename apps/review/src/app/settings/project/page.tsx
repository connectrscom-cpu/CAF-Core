...
const PLATFORM_FIELDS = [
  ...
  { key: "carousel_headline_font_px", label: "Carousel headline size (px)", type: "number" },
  { key: "carousel_body_font_px", label: "Carousel body size (px)", type: "number" },
  { key: "carousel_kicker_font_px", label: "Carousel kicker size (px)", type: "number" },
  { key: "carousel_cta_font_px", label: "Carousel CTA size (px)", type: "number" },
  { key: "carousel_handle_font_px", label: "Carousel handle size (px)", type: "number" },
  {
    key: "carousel_font_scale",
    label: "Carousel font scale (0.75–1.25, optional)",
    type: "number",
  },
