...
const FLOW_TYPE_LABELS: Record<string, string> = {
  ...
  FLOW_VID_UGC: "UGC creator video",
  FLOW_VID_SCENES: "Multi-scene video",
  FLOW_SCENE_ASSEMBLY: "Multi-scene video",
  FLOW_TEXT: "Text post (generic)",
  FLOW_LINKEDIN_TEXT_POST: "LinkedIn text post",
  FLOW_LINKEDIN_DOCUMENT_POST: "LinkedIn post with images",
  FLOW_REDDIT_POST: "Reddit post",
  FLOW_INSTAGRAM_THREAD: "Instagram thread",
  FLOW_HOOKS: "Hooks",
